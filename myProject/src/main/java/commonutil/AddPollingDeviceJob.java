...
public class AddPollingDeviceJob implements Job
{
    ...
    public void execute(JobExecutionContext jobExecutionContext)
    {
        try
        {
            List<HashMap<String, Object>> monitorTableData = CommonTableDao.getTableData("monitor");

            List<HashMap<String, Object>> credentialTableData = CommonTableDao.getTableData("credential");
