        ...
        try
        {
            ...
            if (pingDeviceDetail != null)
            {
                if (!pingDeviceDetail.isEmpty())
                {
                    ...
                    MonitorDao.updateMonitorAvailability(deviceDetail.getId(), (int) pingDeviceDetail.get("availability") == 1 ? "up" : "down");
                ...
                {
                    MonitorDao.updateMonitorAvailability(deviceDetail.getId(), "unknown");
                }
            }
            else
            {
            ...
            PollingDao.addPollingDeviceDetail(pingDeviceDetail, sshPollingDeviceDetail);
