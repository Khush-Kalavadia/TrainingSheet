...
public class ForkJoinPoolUtil
{
    ...
    static
    {
        DISCOVERY_FORK_JOIN_POOL = new ForkJoinPool(Runtime.getRuntime().availableProcessors());

        MONITOR_FORK_JOIN_POOL = new ForkJoinPool(Runtime.getRuntime().availableProcessors() / 2);
    }
