...
public class SynchronizeThisVsClass
{
    ...
    {
        // In this activeMQPointToPoint we are creating 3 threads which access the same method of counter class which runs for 3 sec.
...
//            CounterSynchronizedThis counter2 = counter;
            ...
            // This is similar to synchronized(this) i.e. it runs different instances parallely.

//            CounterSynchronizedMethod counter = new CounterSynchronizedMethod();
//
//            CounterSynchronizedMethod counter1 = new CounterSynchronizedMethod();
//
//            CounterSynchronizedMethod counter2 = new CounterSynchronizedMethod();
