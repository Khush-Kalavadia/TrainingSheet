...
//Application present in ComparableStudentSorting
...
//          Passing comparator using anonymous class
            ...
            Collections.sort(studentList, new Comparator<student>()     //Comparator is an interface so anonymous class has been created to implement abstract methods
            {
                @Override
