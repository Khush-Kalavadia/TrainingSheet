...
public class PasswordEncryption
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        byte[] encryptedText = PasswordEncryption.encryptWithPrefixIV(pText.getBytes(UTF_8), secretKey, iv);
        ...
        String decryptedText = PasswordEncryption.decryptWithPrefixIV(encryptedText, secretKey);
