...
public class Client
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            int valueInput = Integer.parseInt(enter.readLine());

            System.out.println("Enter a string: ");

            String sendString = enter.readLine();

            MyClass writeObj = new MyClass(valueInput, sendString);

            ByteArrayOutputStream outputStream = new ByteArrayOutputStream(1024);       //array of bytes
