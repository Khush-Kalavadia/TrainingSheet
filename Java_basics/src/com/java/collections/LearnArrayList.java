...
public class LearnArrayList
{
    public static void main(String[] args)
    {
        try
        {
            ...
            list.addAll(list1);                     //can putValue complete arraylist
            ...
            list.remove(new Integer(12));     //way 1. remove at given value

//            list.remove(Integer.valueOf(12));     //way 2. remove at given value
...
//            listIt.remove();
//
//            System.out.println("After Remove");                //remove the value pointed by current iterator
