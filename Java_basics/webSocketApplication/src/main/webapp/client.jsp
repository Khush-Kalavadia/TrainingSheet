<!-- Web socket application shows the files present in the webapp folder which was configured
as maven-arktype-webapp while creating the module.
Over here I have created 2 clients on same port.
We can edit the extension in jetty edit configuration or through browser as well and get
http://localhost:8080/webSocketApplication/client.jsp or client1.jsp to open specific page. -->
...
<script type="text/javascript">
    ...
    {
        messageTextArea.value += "Server Connected to client... \n";
    }
